...
public class BookService {
    ...
    public Book createBook(Book book, Integer authorId) {
        ...
        logger.info("Author created successfully with ID: {}", savedBook.getId());
        return savedBook;
    }
    ...
    public Book findBookById(Integer bookId) {
        ...
        if (opt.isEmpty()) {
            logger.info("Book found with this ID : {}", bookId);
    ...
    public Book savedBook(Integer bookId, Integer authorId) throws AuthorNotFoundException, BookNotFoundException {
        ...
        Author book1 = authorRepository.save(author);
        logger.info("Author created successfully with ID: {}", book1.getId());
        return book;
    }
    ...
    public List<Book> getBooks(String genre, boolean isAvailable, String author) {
        logger.info("Received request to fetch books with the following filters - Genre: {}, Available: {}, Author: {}", genre, isAvailable, author);
        if (genre != null && author != null) {
            logger.info("Fetching books with genre: {} and author: {}", genre, author);
        ...
        logger.info("Fetching books based on availability: {}", isAvailable);
